...
export type VisualStylePreset = "glass" | "flat" | "outline" | "soft" | "brutal" | "editorial";
...
export const VISUAL_STYLE_PRESETS: Record<VisualStylePreset, ComponentAppearanceTokens> = {
  ...
  flat: {
    box: "rounded-xl border border-[--color-border] bg-[--color-surface]",
    padding: { compact: "p-4", normal: "p-6", spacious: "p-8" },
    hudCorners: false,
    hover: "transition hover:border-[--color-border-strong]",
  },
  outline: {
    box: "rounded-2xl border-2 border-[--color-accent]/40 bg-transparent",
    padding: { compact: "p-4", normal: "p-6", spacious: "p-8" },
    hudCorners: false,
    hover: "transition hover:border-[--color-accent]",
  },
  soft: {
    box: "rounded-2xl border border-[--color-border] bg-[--color-surface] shadow-[0_20px_50px_-30px_rgba(0,0,0,0.35)]",
  ...
  brutal: {
    box: "rounded-none border-2 border-[--color-text] bg-[--color-surface]",
    padding: { compact: "p-4", normal: "p-6", spacious: "p-8" },
    hudCorners: false,
  ...
  editorial: {
    box: "rounded-none border-0 border-t border-[--color-border] bg-transparent",
...
export const CTA_STYLE_PRESETS: Record<CTAStylePreset, string> = {
  ...
  glow: "big-red-button",
  solid:
    "inline-flex items-center justify-center gap-2 rounded-full bg-[--color-primary] px-8 py-4 font-[family-name:var(--font-display)] text-base font-extrabold uppercase tracking-wide text-[--color-text-on-accent] transition hover:brightness-110",
  outline:
    "inline-flex items-center justify-center gap-2 rounded-full border-2 border-[--color-accent] px-8 py-4 font-[family-name:var(--font-display)] text-base font-extrabold uppercase tracking-wide text-[--color-accent] transition hover:bg-[--color-accent-soft]",
  ghost:
    "inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-[--color-text-muted] transition hover:text-[--color-text]",
  "pill-arrow":
    "group inline-flex items-center justify-center gap-3 rounded-full bg-[--color-primary] px-8 py-4 font-[family-name:var(--font-display)] text-base font-extrabold uppercase tracking-wide text-[--color-text-on-accent] transition hover:gap-4",
};
...
export const DIVIDER_PRESETS: Record<DividerPreset, string> = {
  none: "",
  line: "border-t border-[--color-border]",
