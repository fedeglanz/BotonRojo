    ...
    return (
      <main className="relative min-h-screen overflow-hidden">
        ...
        <section className="mx-auto flex min-h-[100svh] max-w-xl flex-col items-center justify-center px-6 text-center">
          <div className="text-xs uppercase tracking-widest text-[--color-accent]">
            Contenido {index} de {total}
          </div>
          <h1 className="mt-3 font-[family-name:var(--font-display)] text-3xl font-extrabold">
            Todavía no está disponible
          </h1>
          <p className="mt-3 text-[--color-muted-1]">Esta entrega se abre en:</p>
          <div className="mt-4">
    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-6 py-16 lg:grid-cols-[1fr_300px] lg:items-start">
        <article className="max-w-2xl">
          ...
          <Reveal className="mt-10 space-y-6 text-lg leading-relaxed text-[--color-muted-1]">
            {paragraphs.map((p, i) => (
              <p key={i}>{p}</p>
            ))}
          </Reveal>
        ...
        <aside className="space-y-4 lg:sticky lg:top-16">
          <div className="glass p-5">
            <div className="text-xs uppercase tracking-widest text-[--color-muted-2]">Progreso</div>
          ...
          {nextUnlockDate && (
            <div className="glass p-5">
              <div className="text-xs uppercase tracking-widest text-[--color-muted-2]">
